        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft:20 }}>
            <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                <TouchableOpacity onPress={() => changeLanguage('en')} style={styles.languageButton}>
                    <Text style={{ fontSize: 14, color: selectedLanguage === 'en' ? Colors.primaryVariant : 'black' }}>EN</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => changeLanguage('es')} style={styles.languageButton}>
                    <Text style={{ fontSize: 14, color: selectedLanguage === 'es' ? Colors.primaryVariant : 'black' }}>ES</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => changeLanguage('pt')} style={styles.languageButton}>
                    <Text style={{ fontSize: 14, color: selectedLanguage === 'pt' ? Colors.primaryVariant : 'black' }}>PT</Text>
                </TouchableOpacity>
            </ScrollView>
        </View>
    );
