...
export const recommendedPlans = [
  {
    id: '1', name: 'Recommended Plan 1: Arms', goal: "Strengthen arm muscles", workouts: [
      ...
      {
        bodyPart: "upper arms", equipment: "dumbbell", gifUrl: "https://v2.exercisedb.io/image/dh6cZYPfwJO5t6", instructions: ["Stand with your feet shoulder-width apart and hold a dumbbell in your right hand.", "Bend your knees slightly and hinge forward at the hips, keeping your back straight.", "Bring your right elbow up to your side, keeping it bent at a 90-degree angle.", "Extend your right arm straight back, squeezing your triceps at the top of the movement.", "Slowly lower the dumbbell back to the starting position.", "Repeat for the desired number of repetitions, then switch sides."], name: "dumbbell one arm kickback", progress: [], secondary: ["shoulders"], target: "triceps", workoutId: 354
      }, 
      {
        bodyPart: "upper arms", 
        equipment: "barbell", 
  ...
  {
    id: '2', name: 'Recommended Plan 2: Core', goal: "Strengthen core muscles", workouts: [
      {
        bodyPart: "waist",
        equipment: "body weight",
  ...
  {
    id: '3', name: 'Recommended Plan 3: Cardio/Legs', goal: "Improve cardio endurance and leg strength", workouts: [
      {
        bodyPart: "upper legs",
        equipment: "body weight",
